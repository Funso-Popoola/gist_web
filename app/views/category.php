...
$categoryId = $GLOBALS["category"]["category_id"];
...
<div id="wrapper">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="hidden" id="category_id"><?php echo($categoryId);?></p>
                    <section id="ccr-latest-post-gallery">
                        <div class="ccr-gallery-ttile">
                            <span></span>

                            <p id="channelheading">CATEGORY NAME</p>
                        </div>
                        <!-- .ccr-gallery-ttile -->
...
<script>
    ...
    window.onload = function(){setUp(PAGE.category)};
</script>
